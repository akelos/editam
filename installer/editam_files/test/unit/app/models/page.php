...
class PageTestCase extends AkUnitTest
{
    ...
    public function _loadPageDependencies(&$Page)
    {
        ...
        $Page->initiateBehavior($Controller);
    }


    public function test_page_slug_validation()
    {
    ...
    public function test_finding_by_url_should_not_show_other_than_published()
    {
        $this->assertFalse($this->Page->findByUrl('/about/our-team'));
        $this->assertFalse($this->Page->findByUrl('/about/our-team/bermi'));
    }

    public function test_finding_by_url_shows_published_if_requested()
    {
    ...
    public function test_page_should_return_its_parts()
    {
        $Page = $this->Page->findByUrl('/');
    ...
    public function test_page_should_return_its_parts_content()
    {
        $Page = $this->Page->findByUrl('/');
    ...
    public function test_page_should_return_inherited_parts()
    {
        $Page = $this->Page->findByUrl('/about');
    ...
    public function test_page_should_return_inherited_parts_content()
    {
        $Page = $this->Page->findByUrl('/about');
    ...
    public function test_page_should_return_part_formatted_as_markdown()
    {
        $Page = $this->Page->findByUrl('/');
    ...
    public function test_page_should_return_part_formatted_as_textile()
    {
    ...
    public function test_published_at_date_should_be_updated_when_status_is_changed_to_published()
    {
    ...
    public function test_published_at_not_updated_on_save_because_already_published()
    {
        $Page = $this->Page->findByUrl('/');
    ...
    public function test_page_should_return_current_layout()
    {
        $Page = $this->Page->findByUrl('/');
    ...
    public function test_page_should_return_inherited_layout()
    {
        $Page = $this->Page->findByUrl('/about');
    ...
    public function test_should_return_part_instance()
    {
        $Page = $this->Page->findByUrl('docs');
    ...
    public function test_should_return_layout()
    {
        $Page = $this->Page->findByUrl('docs');
        $this->_loadPageDependencies($Page);
    ...
    public function test_should_return_filtered_body()
    {
        $Page = $this->Page->findByUrl('docs');
        $this->_loadPageDependencies($Page);
        $this->assertEqual($Page->getFilteredPart('body'), 'Documentation body');
    ...
    public function test_destroy_dependent_parts()
    {
    ...
    public function test_destroy_nested_elements_and_their_dependent_parts()
    {
    ...
    public function test_should_not_allow_changing_page_locale()
    {
        $Page = $this->Page->findByUrl('/about/our-team/bermi',true);
