        ...
        <div id="main-content">
          ...
          <ol>
            <li>_{Copy the following configuration file contents to <b>config/config.php</b>.}
                <?= $form_tag_helper->start_form_tag(array('controller'=>'editam_setup','action'=>'perform_setup')) ?>
            ...
            <?php if(strlen($EditamSetup->getUrlSuffix()) > 1) : ?>
            ...
            _{with} <br />
            <b> RewriteBase <?=$EditamSetup->getUrlSuffix()?></b> </li>
            <?php endif; ?>
